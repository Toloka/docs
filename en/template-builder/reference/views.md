...
Use the components named `view.*` for the elements displayed in the interface, such as text, list, audio player, or image. An Toloker can't change these components. Use the [data entry components](fields.md) (fields) where you want Tolokers to enter something.
