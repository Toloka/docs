...
The `else` property is optional. For example, let's say you ask the annotator "did you Like the image". You can make a comment field appear when a negative response is received, but nothing happens when a positive response is received.
