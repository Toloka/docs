...
You can list in the `accept` property the file types that will be suggested to the annotator when uploading. By default, only one file can be uploaded, but you can allow multiple files in the `multiple` property.
...
|| `accept` | _array_ | A list of file types that will be suggested to the annotator when uploading. By default, you can upload any files.
