...
- [condition.played](../reference/condition.played.md): Checks that an annotator started watching the video.
...
The [helper.switch](../reference/helper.switch.md) component displays an interface element after a specific response is selected. In this example, an annotator can only select correct statements about the video if it loaded.
