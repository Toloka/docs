...
- [condition.played](../reference/condition.played.md): Checks that the annotator started watching the video.
...
The [helper.switch](../reference/helper.switch.md) component displays an interface element after a specific response is selected. In this example, the annotator can only select correct statements about the video if it loaded.
