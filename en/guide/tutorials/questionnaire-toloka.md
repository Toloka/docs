...
1. {% include [tutorials-add-name-description](../_includes/tutorials/add-name-description.md) %}
    ...
    <a target="_blank" href="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/survey-create-project-step-1-toloka.png"><img src="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/survey-create-project-step-1-toloka.png" alt="Create a project. Step 1" style="border-radius:6px;cursor:zoom-in;width:700px;" /></a>
...
1. In the {% if locale == "en-com" %}**Task interface**{% endif %} section, set up what your tasks will look like.
    ...
    1. Edit the code: change questions, hints, and answer options. For example, to configure the text of the answer option, replace the sample answers with your values in the following properties:
        ...
        <a target="_blank" href="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/survey-config-question-answer.png"><img src="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/survey-config-question-answer.png" alt="Create a project. Config question answer" style="border-radius:6px;cursor:zoom-in;width:700px;" /></a>
    ...
    1. The example code contains one question with an obvious answer to check how attentive a Toloker is. You can change this question if needed:
        ...
        <a target="_blank" href="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/survey-config-question-attention.png"><img src="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/survey-config-question-attention.png" alt="Create a project. Config question attention" style="border-radius:6px;cursor:zoom-in;width:700px;" /></a>
...
1. {% include [toloka-requester-source-start-button](../_includes/toloka-requester-source/id-toloka-requester-source/start-button.md) %}
    ...
    <a target="_blank" href="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/survey-start-labeling-toloka.png"><img src="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/survey-start-labeling-toloka.png" alt="Start labeling" style="border-radius:6px;cursor:zoom-in;width:700px;" /></a>
...
1. After checking all the assignments, сlick the {% if locale == "en-com" %}**Download results**{% endif %} button.
    ...
    <a target="_blank" href="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/questionnaire-download-results.png"><img src="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/questionnaire-download-results.png" alt="See the results. Download results" style="border-radius:6px;cursor:zoom-in;width:700px;" /></a>
...
1. In the {% if locale == "en-com" %}**Download results**{% endif %} dialog, do the following:
    ...
    <a target="_blank" href="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/questionnaire-download-settings.png"><img src="https://yastatic.net/s3/doc-binary/src/support/toloka/en/guide/tutorials/questionnaire/questionnaire-download-settings.png" alt="See the results. Download settings" style="border-radius:6px;cursor:zoom-in;width:458px;" /></a>
