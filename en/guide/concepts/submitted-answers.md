...
----- | -----
{% if locale == "en-com" %}**If**{% endif %} | A condition for performing the action in the {% if locale == "en-com" %}**then**{% endif %} field:<br/>- {% if locale == "en-com" %}**submitted assignments**{% endif %} — The number of task suites in the pool completed by the Toloker.
