...
Don't add [training or control tasks](../pool.md) to a [project](../../../glossary.md#project-ru) that features an image area selection editor.
...
``` src ``` | Image URL. Supported values:<br/><br/>- URL from the task input data. For example, from the field with the `url`: `src=image` ID.<br/>    <br/>- Direct link. The HTTPS protocol is recommended. For example, `src="https://mywebsite.ru/img1.png"`.<br/>    <br/>- Relative link. | yes | no
...
Tell Tolokers about keyboard shortcuts in the [instructions](../../../glossary.md#task-instruction-ru) to speed up task completion.

## Selection tools {#selection_tools}

By default, the polygon tool is added to the [task interface](../../../glossary.md#task-interface-ru).
