...
{% if locale == "en-com" %}**Captcha frequency**{% endif %} | The frequency of [captcha](../../glossary.md#captcha-rule-ru) display:<br/><br/>- <q>No</q> — Don't show captchas.<br/>    <br/>- <q>Low</q> — Show a captcha after every 20 assignments.<br/>    <br/>- <q>Medium</q>/ <q>High</q> — Show a captcha after every 10 assignments.<br/>    <br/><br/>To show the captcha to Tolokers, set [the quality control rule](captcha.md). | {% if locale == "en-com" %}**Quality control**{% endif %}
...
For example, you create <q>Pool 1</q> and <q>Pool 2</q> with the same settings in the <q>Are there traffic signs in the photo?</q> project. If the Toloker has access to both pools, they are displayed as a single card on the main page. ![](../_images/other/toloka-1pool.png)
