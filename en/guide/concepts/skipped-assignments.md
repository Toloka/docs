...
- Tasks must be performed in order and skipping tasks may affect the quality. In this case, don't forget to enable [Keep task order](task_upload.md#how-save-order-tasks).
