{% cut "Fraudulent Tolokers submit assignments with empty task response fields. Are they going to be banned before the task responses of other Tolokers are known?" %}
