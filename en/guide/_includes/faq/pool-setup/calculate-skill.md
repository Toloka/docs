...
You can merge all the projects into one and use **History size** in the quality control rules. See examples in the [Control tasks](../../../../guide/concepts/goldenset.md) post.
