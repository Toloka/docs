{% cut "I registered in Toloka using my personal Microsoft account. Next time I tried to sign in to Toloka using Microsoft enterprise account, but a new Toloka account was created" %}
