...
This page contains the list of the regions of Tolokers to which you give preference or filter out using the value of the `region_by_phone` and `region_by_ip` parameters (refer to the [Filter by computed data](filter-computed.md#params) page for details). You can specify countries, federal subjects, and cities as the region.
