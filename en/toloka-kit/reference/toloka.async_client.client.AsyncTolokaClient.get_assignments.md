# get_assignments
`toloka.async_client.client.AsyncTolokaClient.get_assignments` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0.post1/src/client/__init__.py#L0)
