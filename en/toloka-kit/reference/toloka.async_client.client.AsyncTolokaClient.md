# AsyncTolokaClient
`toloka.async_client.client.AsyncTolokaClient` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.1.0.post1/src/async_client/client.py#L26)
...
[archive_pool](toloka.async_client.client.AsyncTolokaClient.archive_pool.md)| Sends pool to archive
[archive_pool_async](toloka.async_client.client.AsyncTolokaClient.archive_pool_async.md)| Sends pool to archive, asynchronous version
...
[archive_training](toloka.async_client.client.AsyncTolokaClient.archive_training.md)| Sends training to archive
[archive_training_async](toloka.async_client.client.AsyncTolokaClient.archive_training_async.md)| Sends training to archive, asynchronous version
[clone_pool](toloka.async_client.client.AsyncTolokaClient.clone_pool.md)| Duplicates existing pool
[clone_pool_async](toloka.async_client.client.AsyncTolokaClient.clone_pool_async.md)| Duplicates existing pool, asynchronous version
...
[clone_training](toloka.async_client.client.AsyncTolokaClient.clone_training.md)| Duplicates existing training
[clone_training_async](toloka.async_client.client.AsyncTolokaClient.clone_training_async.md)| Duplicates existing training, asynchronous version
[close_pool](toloka.async_client.client.AsyncTolokaClient.close_pool.md)| Stops distributing tasks from the pool
[close_pool_async](toloka.async_client.client.AsyncTolokaClient.close_pool_async.md)| Stops distributing tasks from the pool, asynchronous version
[close_pool_for_update](toloka.async_client.client.AsyncTolokaClient.close_pool_for_update.md)| Closes pool for update
[close_pool_for_update_async](toloka.async_client.client.AsyncTolokaClient.close_pool_for_update_async.md)| Closes pool for update, asynchronous version
[close_training](toloka.async_client.client.AsyncTolokaClient.close_training.md)| Stops distributing tasks from the training
[close_training_async](toloka.async_client.client.AsyncTolokaClient.close_training_async.md)| Stops distributing tasks from the training, asynchronous version
...
[create_pool](toloka.async_client.client.AsyncTolokaClient.create_pool.md)| Creates a new pool
...
[create_training](toloka.async_client.client.AsyncTolokaClient.create_training.md)| Creates a new training
...
[find_trainings](toloka.async_client.client.AsyncTolokaClient.find_trainings.md)| Finds training pools that match certain criteria.
...
[get_pool](toloka.async_client.client.AsyncTolokaClient.get_pool.md)| Reads one specific pool
...
[get_training](toloka.async_client.client.AsyncTolokaClient.get_training.md)| Reads one specific training
[get_trainings](toloka.async_client.client.AsyncTolokaClient.get_trainings.md)| Finds all training pools that match certain criteria.
...
[open_pool](toloka.async_client.client.AsyncTolokaClient.open_pool.md)| Starts distributing tasks from the pool
[open_pool_async](toloka.async_client.client.AsyncTolokaClient.open_pool_async.md)| Starts distributing tasks from the pool, asynchronous version
[open_training](toloka.async_client.client.AsyncTolokaClient.open_training.md)| Starts distributing tasks from the training
[open_training_async](toloka.async_client.client.AsyncTolokaClient.open_training_async.md)| Starts distributing tasks from the training, asynchronous version
...
[patch_pool](toloka.async_client.client.AsyncTolokaClient.patch_pool.md)| Changes the priority of the pool issue
...
[update_pool](toloka.async_client.client.AsyncTolokaClient.update_pool.md)| Makes changes to the pool
...
[update_training](toloka.async_client.client.AsyncTolokaClient.update_training.md)| Makes changes to the training
