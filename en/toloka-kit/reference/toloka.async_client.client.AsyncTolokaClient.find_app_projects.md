# find_app_projects
`toloka.async_client.client.AsyncTolokaClient.find_app_projects` | [Source code](https://github.com/Toloka/toloka-kit/blob/v1.2.0.post1/src/client/__init__.py#L0)
