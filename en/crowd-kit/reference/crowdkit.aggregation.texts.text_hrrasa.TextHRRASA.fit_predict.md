# fit_predict
`crowdkit.aggregation.texts.text_hrrasa.TextHRRASA.fit_predict` | [Source code](https://github.com/Toloka/crowd-kit/blob/v1.1.0.rc4/crowdkit/aggregation/texts/text_hrrasa.py#L76)
