...
В Толоке в настройках проекта должна быть указана спецификация [входных и выходных данных](../glossary.md#input-output-data). Если вы используете конструктор шаблонов в интерфейсе Толоки, то спецификация создается автоматически.
