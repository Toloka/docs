...
В Яндекс Толоке в настройках проекта должна быть указана спецификация
{% cut "входных и выходных данных" %}
...
О работе с данными в инструкции [Чтение и запись](input-output-data.md).

{% endcut %}

. Если вы используете конструктор шаблонов в интерфейсе Толоки, то спецификация создается автоматически.
...
Например, вы можете скрыть идентификатор `assigment_id`, который вам понадобится при выполнении
{% cut "отложенной приемки" %}
...
, который позволяет проверять ответы и при этом не платить за задания, которые исполнители сделали некачественно.
...
**Параметр в JSON:** `min_size`

**
Описание
:** Минимальное число элементов в массиве.

**Параметр в JSON:** `max_size`

**
Описание
:** Максимальное число элементов в массиве.

**Параметр в JSON:** `allowed_values`
...
**Параметр в JSON:** `max_length`

**
Описание
:** Максимальная длина строки

**Параметр в JSON:** `min_value`

**
Описание
:** Минимальное значений для дробных и целых чисел.

**Параметр в JSON:** `max_value`
...
- Если вы редактируете обязательные поля, изменения применятся только к новым
    {% cut "пулам" %}
    ...
    заданий. Например, если вам пришлось исправить ошибку в проекте, [клонируйте пул](https://toloka.ai/ru/docs/guide/concepts/pool-main.html) или [создайте новый](https://toloka.ai/ru/docs/guide/concepts/pool-main.html). Существующие пулы заданий будут работать в соответствии со старой версией проекта.
