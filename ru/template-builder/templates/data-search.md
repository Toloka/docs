...
В Толоке есть шаблон  **Сбор контактов организаций** ([посмотреть код в песочнице](https://clck.ru/USPkB)). В нем уже настроена валидация и внешний вид задания. В этом шаблоне исполнителю предлагается ввести контактную информацию об организации на основе поиска данных в сети.
