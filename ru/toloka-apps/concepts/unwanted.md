...
Вы можете размещать любые задания, требующие анализа или создания контента. Толока **не предназначена** для заданий, которые могут нанести вред исполнителям. Ваш аккаунт может быть заблокирован, если задания:
