...
Вариант расстановки элементов (layout) — конструктор шаблонов
...
Действие (action) — конструктор шаблонов
...
Отображаемый элемент (view) — конструктор шаблонов
...
Плагин (plugin) — конструктор шаблонов
...
Поле для ввода данных (field) — конструктор шаблонов
...
Условие (condition) — конструктор шаблонов
...
Хелпер (helper) — конструктор шаблонов
