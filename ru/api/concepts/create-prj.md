...
Количество страниц, которые исполнитель может одновременно выполнять (статус <q>Активно</q>).||
...
- `coordinates` — географические координаты (например, <q>53.910236, 27.531110</q>).||
||**required** | **boolean**
