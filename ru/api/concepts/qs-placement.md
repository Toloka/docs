...
- Песочница
  ...
  1. Получите OAuth-токен в [кабинете заказчика](https://sandbox.toloka.yandex.ru/requester/profile/integration).
...
- Основная версия
  ...
  1. [Зарегистрируйтесь]({{ requester-access }}) на выбранной платформе, если вы не делали этого ранее.
  1. Получите OAuth-токен в [кабинете заказчика](https://toloka.yandex.ru/requester/profile/integration).
