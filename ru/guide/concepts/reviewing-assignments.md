...
- **количество проверенных ответов** — количество проверенных заданий исполнителя.

- **процент принятых ответов** — доля принятых заданий исполнителя (от 0 до 100).

- **процент отклоненных ответов** — доля отклоненных заданий исполнителя (от 0 до 100).
