...
1. Откройте страницу [проекта](../../glossary.md#project-ru), перейдите на вкладку {% if locale == "ru-ru" %}**Обучения**{% elsif locale == "en-com" %}**Training**{% endif %} и нажмите кнопку {% if locale == "ru-ru" %}**Добавить обучение**{% elsif locale == "en-com" %}**Add training**{% endif %}.
