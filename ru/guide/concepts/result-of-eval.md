...
- `OUTPUT:<название поля [выходных данных](incoming.md)>` — ответы исполнителей. Для [обучающих заданий](../../glossary.md#training-task) приводятся ответы, которые были даны при первой попытке выполнить задание.

- `GOLDEN:<название поля [выходных данных](incoming.md)>` — ответы для [контрольных заданий](../../glossary.md#control-task).

- `HINT:text` — подсказки для обучающих заданий.

- Информация о выполнении задания (дублируется для всех заданий на странице):

    - `ASSIGNMENT:link` — ссылка на просмотр [страницы заданий](../../glossary.md#task-page).
