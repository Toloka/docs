...
1. **Создание [пула заданий](../../glossary.md#pool) в проекте.** В пуле вы настраиваете [контроль качества](../../glossary.md#quality-control-ru) и [фильтры](../../glossary.md#filtering-ru) по исполнителям.
