...
#|
|| | **Заработок** | **Пропуск заданий** | **Контрольные задания** | **Мнение большинства** | *Выполненные задания* | **Быстрые ответы** ||
||**Начальный** | + | + | − | − | − | −||
||**Базовый** | + | + | + | + | − | −||
||**Продвинутый** | + | + | + | + | + | +||
|#
...
{% cut "Большой пул 1% контрольных заданий (хорошо)
...
{% cut "Маленький пул 1% контрольных заданий (плохо)
...
{% cut "Маленький пул 10% контрольных заданий (хорошо)
