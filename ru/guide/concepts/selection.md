...
- Сортировка изображений, на которых есть объект.
    ...
    - [Создайте задание](categorization.md), используя шаблон «Классификация изображений».
...
- Выделение объекта на изображениях.
    ...
    - Используйте правила контроля качества: быстрые ответы, отложенная приемка, дооценка после приёмки. [Описание правил и примеры](control.md).
