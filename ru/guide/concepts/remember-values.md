...
- в [страницах заданий](../../glossary.md#task-page) — правило [Быстрые ответы](quick-answers.md), поле **Учитывать последних страниц заданий**;
- в вводах [капчи](../../glossary.md#captcha-rule) — правило [Капча](captcha.md), поле **Учитывать последних вводов капчи**.
