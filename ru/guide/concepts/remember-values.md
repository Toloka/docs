# Параметр <q>Помнить значений</q>

В ряде правил контроля качества есть параметр **Помнить значений**. Этот параметр устанавливает динамическое окно равное N, в рамках которого будут пересчитываться значения. В зависимости от правила динамическое окно может измеряться:
...
- в контрольных заданиях — правило [Контрольные задания](goldenset.md), поле **Учитывать последних ответов на контрольные и обучающие задания**;
- в страницах заданий — правило [Быстрые ответы](quick-answers.md), поле **Учитывать последних страниц заданий**;
- в вводах капчи — правило [Капча](captcha.md), поле ** Учитывать последних вводов капчи**.

Параметр **Помнить значений** одинаково работает для всех правил.

## Как работает {#how-field-works}

Рассмотрим работу параметра на примере правила [Контрольные задания](goldenset.md). Перейдите в настройки проекта и выберите это правило контроля качества.
...
№ задания
 | Попадание в ответ на контрольное задание | 
Изменение навыка
 | 
Описание
...
- Исполнителю не будет назначаться навык. Все вычисления Толока будет производить <q>в уме</q>.
...
#### Пример 3 с назначением навыка и баном

Правило работает как в Примере 1 и Примере 2 одновременно.

#### Пример 4 с назначением навыка, баном и разными параметрами
