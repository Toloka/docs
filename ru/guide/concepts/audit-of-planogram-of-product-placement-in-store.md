...
1. Выберите шаблон:
    ...
    1. Выберите шаблон {% if locale == "ru-ru" %}**Аудит планограммы выкладки товаров в магазине**{% endif %}{% if locale == "en-com" %}**Audit of the planogram of products displayed in the store**{% endif %} в блоке {% if locale == "ru-ru" %}**Пешеходные задания**{% endif %}{% if locale == "en-com" %}**Spatial Crowdsourcing**{% endif %}.
