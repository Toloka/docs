...
`input_result` — поле для ввода строки.

Добавьте столько полей, сколько вам требуется, но придумайте им уникальные имена. Например, если вам нужно три поля для ввода строки, добавьте три поля с именами `input_result1`, `input_result2` и `input_result3`.

В шаблоне используется специальный компонент, облегчающий разработку. Подробнее о нем можно прочитать в разделе [Поле для ввода строки](t-components/string.md).
...
1. {% include [advanced-features-input-selector-html-main-1](../_includes/concepts/advanced-features-input-selector/id-advanced-features-input-selector/html-main-1.md) %}
    ...
    Новые поля перечислены в блоке `main__box` в виде строк:
...
1. Обновите режим приемки.
    ...
    {% include [advanced-features-input-string-html-add-string-1](../_includes/concepts/advanced-features-input-string/id-advanced-features-input-string/html-add-string-1.md) %}

    Новые поля перечислены в блоке `review__box` в виде строк:
    ...
    {% include [advanced-features-input-string-html-add-string-2](../_includes/concepts/advanced-features-input-string/id-advanced-features-input-string/html-add-string-2.md) %}

    {% include [advanced-features-input-string-html-add-string-3](../_includes/concepts/advanced-features-input-string/id-advanced-features-input-string/html-add-string-3.md) %}

    {% include [advanced-features-input-string-html-string-placeholder](../_includes/concepts/advanced-features-input-string/id-advanced-features-input-string/html-string-placeholder.md) %}
...
1. Чтобы добавить нужные тексты для нового поля, поставьте запятую после закрывающей фигурной скобки последнего поля и вставьте следующий код:
    ...
    Измените значения свойств `title` и `description`. Свойство `title` содержит заголовок, который будет отображаться над текстовым полем, а `description` — вопрос для исполнителя.
