...
Вы также можете [обратиться к нам или нашим партнерам](get-help.md) за помощью в запуске проекта целиком или отдельных шагов, например в [разметке заданий](../../glossary.md#task-markup-ru).
 {% if locale == "ru-ru" %}
...
#### Настройка задания <q>Анализ тональности и модерация контента</q>
...
#### Настройка задания <q>Сбор данных</q>
