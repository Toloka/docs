...
1. Сортировка изображений, на которых есть объект.
    ...
    1. [Создайте задание](categorization.md), используя пресет **Классификация изображений**.
...
Рекомендуем взять за основу пресет [**Анализ тональности и модерация контента**](content-moderation.md).
...
[Используйте](selection.md) пресет **Распознавание объектов и выделение областей**. Через редактор из этого пресета можно добавить выпадающий список для маркировки выделенного объекта. Посмотрите как это сделать в [описании](t-components/image-annotation.md#annotation) редактора (вкладка **Выпадающий список**).
