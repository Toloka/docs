...
Ответы заблокированных исполнителей будут учтены, если не отклонить их вручную при помощи [отложенной приемки](../../glossary.md#left-off-acceptance). Чтобы отправить задания этих исполнителей на повторную разметку, настройте правило.
...
- {% if locale == "ru-ru" %}**заблокирован**{% endif %}{% if locale == "en-com" %}**banned**{% endif %} — доступ исполнителя к заданиям заблокирован по одному из [правил контроля качества](../../glossary.md#quality-control-rules) (например, контрольные задания, мнение большинства, [быстрые ответы](../../glossary.md#fast-responses-rule), [пропуск заданий](../../glossary.md#skipped-tasks), ввод [капчи](../../glossary.md#captcha-rule)).

- {% if locale == "ru-ru" %}**вне фильтра**{% endif %}{% if locale == "en-com" %}**filtered out**{% endif %} — исполнитель перестал соответствовать хотя бы одному из установленных [фильтров](filters.md).
