...
- хотите получить по каждому заданию в заданном перекрытии ответы добросовестных исполнителей;
- не боитесь заплатить за это больше.
...
1. На странице пула нажмите **Скачать результаты**.
...
- {% if locale == "ru-ru" %}**исполнитель заблокирован**{% endif %}{% if locale == "en-com" %}**banned**{% endif %} — доступ исполнителя к заданиям заблокирован по одному из [правил контроля качества](../../glossary.md#quality-control-rule) (например, контрольные задания, мнение большинства, [быстрые ответы](../../glossary.md#fast-responses), [пропуск заданий](../../glossary.md#skipping-tasks), ввод [капчи](../../glossary.md#captcha)).

- {% if locale == "ru-ru" %}**исполнитель вне фильтра**{% endif %}{% if locale == "en-com" %}**filtered out**{% endif %} — исполнитель перестал соответствовать хотя бы одному из установленных [фильтров](filters.md).
