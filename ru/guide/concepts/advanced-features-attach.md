              ...
              <div class="review__audio-grid">
                {{#each new_audio}}
                  <div class="review__audio-grid-item">
                    <audio src=not_var{{this}} controls type="audio/wav">Невозможно воспроизвести</audio>
                  </div>
                {{/each}}
              </div>
            </div>
            ...
            <div class="main__block">
                ...
                <div class="main__content">
                    ...
                    <div class="main__content-block">
                      ...
                      <div class="main__ex">
                        <a href="not_var{{texts.btn_ok.question_new_imgs.example_link_1}}" target="_blank" class="main__ex-link">Пример</a>
                      </div>
                      <div class="main__imgs">
            ...
            <div class="main__block">
                ...
                <div class="main__content">
                    <div class="main__content-block">
                        ...
                        <div class="main__ex">
                            <a href="not_var{{texts.btn_no_obj.question_1.example_link_1}}" target="_blank" class="main__ex-link">Пример</a>
                        </div>
                        <div class="main__imgs">
                    ...
                    <div class="main__content-block">
                        ...
                        <div class="main__ex">
                            <a href="not_var{{texts.btn_no_obj.question_3.example_link_1}}" target="_blank" class="main__ex-link">Пример</a>
                        </div>
                        <div class="main__imgs">
            ...
            <div class="main__block">
                ...
                <div class="main__content">
                    ...
                    <div class="main__content-block">
                        ...
                        <div class="main__ex">
                            <a href="not_var{{texts.btn_no_org.question_2.example_link_1}}" target="_blank" class="main__ex-link">Пример</a>
                        </div>
                        <div class="main__imgs">
                            {{field type="file-img" name="imgs_plate_or_address" camera=true validation-show="top-left"}}
                        </div>
...
- [Кнопка для записи и загрузки видео](t-components/upload-video.md)
