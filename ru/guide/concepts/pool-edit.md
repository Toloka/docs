...
Чтобы изменить параметры пула, нажмите кнопку **Редактировать** вверху страницы пула или ![](../_images/edit.svg) в списке пулов на странице [проекта](../../glossary.md#project).
...
Подсчитывается автоматически с учетом комиссии.
...
Если вы не проверяли задания на наличие подобного контента, выберите опцию **В моих заданиях может содержаться шокирующий или порнографический контент**.
...
Это поле доступно только, если вы заполнили поле **Обучение**.
...
#### **Время ожидания закрытия пула, с**

Интервал, в течении которого пул будет оставаться открытым с момента выполнения всех заданий. Минимум — 0 (1 в случае использования динамического перекрытия), максимум — 259 200 секунд (трое суток).
