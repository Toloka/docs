...
1. В блоке **Контроль качества** выберите правила, которые вам нужны.

    Если вы не уверены, какие правила контроля качества вам нужны, выберите готовый набор с настройками по умолчанию.

1. Задайте настройки для добавленных правил. Подробную информацию см. в разделе [Список правил](#rules).
...
1. В блоке **Аудитория** нажмите кнопку **Скопировать из другого пула**.
