...
Правила контроля качества, которые вы задали в [проекте](../../glossary.md#project-ru), будут действовать во всех [пулах](../../glossary.md#pool-ru) проекта, и изменить их настройку в одном из пулов невозможно.
...
- **Чтобы следить за тем, как часто ошибаются исполнители:**
    - [Контрольные задания](goldenset.md) — позволяет устанавливать исполнителю [навык](../../glossary.md#skill-ru) на основе его ответов на контрольные задания и блокировать доступ исполнителям, которые дают неправильные ответы.
...
- **Для защиты от роботов и недобросовестных исполнителей:**
    - [Быстрые ответы](quick-answers.md) — позволяет следить за минимальным временем на выполнение [страницы заданий](../../glossary.md#task-page-ru).
...
- **Чтобы привлечь разных исполнителей:**
    - [Заработок](income.md) — позволяет ограничить заработок исполнителя в [пуле](../../glossary.md#pool-ru) в течение суток.
...
- **Для повторного выполнения некоторых заданий:**
    - [Повторное выполнение заданий после блокировки исполнителя](restore-task-overlap.md) — если исполнитель был заблокирован, то [выполненные задания](../../glossary.md#submitted-answers-ru) можно отправить другим исполнителям с помощью этого правила.
