...
1. Нажмите кнопку **Добавить пул** на странице проекта.

1. Задайте параметры пула, нажмите **Сохранить**.
...
Чтобы клонировать пул, нажмите кнопку **![Выпадающее меню](../_images/drop-down.svg) → Клонировать** вверху страницы пула или ![](../_images/clone-pool.svg) в списке пулов на странице проекта.
