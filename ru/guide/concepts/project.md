...
1. [Напишите инструкцию](instruction.md) для исполнителей.
...
Чтобы клонировать проект, в списке проектов нажмите кнопку ![](../_images/location-job/project/clone-project.svg) или на странице проекта выберите **Действия над проектом → Клонировать**.
