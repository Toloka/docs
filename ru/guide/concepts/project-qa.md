...
Настройки контроля качества в [проекте](../../glossary.md#project-ru) будут действовать во всех [пулах](../../glossary.md#pool-ru) проекта, и изменить их настройку в одном из пулов будет невозможно.
