...
{% endif %}{% if locale == "ru-ru" %}@[youtube](https://www.youtube.com/embed/F-SJwLw-zLk?utm_source=support&utm_medium=online&utm_compaign=help&utm_content=requesters&?rel=0){% endif %}{% if locale == "ru-ru" %}
...
{% endif %}{% if locale == "ru-ru" %}@[youtube](https://www.youtube.com/embed/YxpFLKXZ1dM?utm_source=support&utm_medium=online&utm_compaign=help&utm_content=requesters&?rel=0){% endif %}
Также смотрите:
