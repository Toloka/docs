...
После прохождения [обучения](../../glossary.md#training-pool) исполнителю автоматически назначается [тренировочный навык](../../glossary.md#train-skill) с процентом правильных ответов.
