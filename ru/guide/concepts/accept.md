...
1. Загрузите отредактированный файл в Толоку ({% if locale == "ru-ru" %}**Импорт/ Экспорт  → Загрузить результаты**{% elsif locale == "en-com" %}**Import/ Export → Upload results**{% endif %}).
