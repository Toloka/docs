...
1. Выберите задание.
    ...
    Если в ответах содержатся файлы, отправленные исполнителями, нажмите **Действия → Скачать вложения**, чтобы скачать их. Чтобы скачать все файлы из непроверенных ответов в ZIP-архиве, нажмите **Скачать результаты → Скачать вложения** на странице проверки заданий.

1. Проверьте ответы, нажмите **Принять** или **Отказать**. Для отклоненных ответов введите комментарий (укажите причину).
...
1. Чтобы скачать ответы, которые вы еще не проверяли: на странице пула нажмите кнопку **Скачать результаты**. В открывшемся окне:
...
1. Если по условию задания толокеры должны были отправить вам картинки/видео/аудио, скачайте их для проверки отдельным архивом следующим образом.
    ...
    Нажмите **Скачать результаты → Скачать вложения**.
...
1. Откройте [файл с ответами](result-of-eval.md).
    ...
    **Расшифровка**
    ...
    - `ACCEPT:comment` — комментарий для исполнителя в случае отклонения ответов (например, укажите несоблюденный пункт [инструкции](../../glossary.md#instructions)).

1. Загрузите отредактированный файл в Толоку (**Импорт/ Экспорт  → Загрузить результаты**).
