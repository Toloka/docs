...
1. В расширенных настройках включите опцию **Использовать динамическое перекрытие**.

1. Установите **Максимальное перекрытие**.

1. Укажите **Уверенность в агрегированном ответе**. Чем выше значение, тем более согласованным будет агрегированный ответ. Не устанавливайте значение меньше 70.

1. Выберите **Навык для взвешивания ответов исполнителей**.

1. Отметьте **Выходные данные для агрегации**.
...
**Приблизительный бюджет** в [статистике пула](pool_statistic-pool.md) будет рассчитан на основе минимального перекрытия.
