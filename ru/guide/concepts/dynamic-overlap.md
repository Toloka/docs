...
- Устанавливайте уверенность в агрегированном ответе на уровне от 70 до 95 процентов.
    ...
    Оптимальная уверенность находится на уровне 80%. При такой настройке соотношение <q>цена-качество</q> будет наиболее приемлемым.

- Загружайте задания через **умное смешивание**, иначе задания пула будут выданы с минимальным перекрытием.

    Это нужно для того, чтобы механизм мог повышать перекрытие, так как [контрольные](../../glossary.md#control-task-ru) и [обучающие](../../glossary.md#training-task-ru) задания, загруженные через **умное смешивание** имеют бесконечное перекрытие.
