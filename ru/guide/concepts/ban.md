...
1. Нажмите кнопку **Действия → Заблокировать**, заполните поля:

    #|
    ||**Поле**|**Описание**||
    ||**Место блокировки** | Область действия блокировки:

    - **У меня** — все проекты;
    - **На проекте** — один проект (выберите проект из списка).||
    ||**Дата разблокировки** | Укажите, когда нужно снять блокировку.

    Рекомендуется блокировать доступ на время, чтобы поддерживать нужное количество исполнителей, выполняющих задания.||
    ||**Причина** | Причина блокировки (доступна только заказчику).||
    |#
...
1. Нажмите кнопку **Заблокировать**, заполните поля (см. таблицу выше).

Сведения о доступе к заданиям можно просмотреть на странице исполнителя (перейдите на нее со страницы [Пользователи]({{ users }})), вкладка **Блокировки**. Чтобы разблокировать доступ к заданиям, наведите курсор на строку блокировки и нажмите кнопку ![](../_images/location-job/task-edit/task-action-delete.svg).
