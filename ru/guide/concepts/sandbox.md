...
1. Откройте страницу [Исполнители]({{ users }}) и нажмите **Добавить доверенных исполнителей**.

1. Нажмите кнопку **Добавить исполнителей** и введите логин созданного исполнителя с учетом регистра букв (заглавные и строчные).
...
1. Cвяжите аккаунты песочницы и основной версии:
    ...
    1. Откройте вкладку **Интеграции** в основной версии на странице [профиля]({{ profile }}), нажмите **Получить OAuth-токен** и скопируйте отобразившийся OAuth-токен.
...
1. Перейдите на страницу проекта в песочнице и нажмите кнопку **![Выпадающее меню](../_images/drop-down.svg) → ![Экспортировать](../_images/location-job/project/export.svg) Экспортировать**.
